...
class CVACTDatasetTrain(Dataset):
    ...
    def __init__(self,
        ...
        for idx in train_ids.squeeze():
            ...
            grd_path = f'small/streetview/{idx}_grdView.jpg'
            sat_path = f'small/satview_polish_polarmap/{idx}_satView_polish.jpg'
    ...
    def __getitem__(self, index):
        ...
        query_img = cv2.imread(f'{self.data_folder}/small/streetview/{idx}_grdView.jpg')
        query_img = cv2.cvtColor(query_img, cv2.COLOR_BGR2RGB)
        
        # load reference -> satellite image
        reference_img = cv2.imread(f'{self.data_folder}/small/satview_polish_polarmap/{idx}_satView_polish.jpg')
        ...
        if np.random.random() < self.prob_rotate:
            ...
            shifts = - w//4 * r
            reference_img = torch.roll(reference_img, shifts=shifts, dims=2)  
...
class CVACTDatasetEval(Dataset):
    ...
    def __init__(self,
        ...
        for idx in ids.squeeze():
            ...
            grd_path = f'{self.data_folder}/small/streetview/{idx}_grdView.jpg'
            sat_path = f'{self.data_folder}/small/satview_polish_polarmap/{idx}_satView_polish.jpg'
        ...
        print('eval_sample_len:{}'.format(len(self.samples)))
    ...
    def __getitem__(self, index):
        ...
        if self.img_type == "reference":
            path = f'{self.data_folder}/small/satview_polish_polarmap/{idx}_satView_polish.jpg'
        elif self.img_type == "query":
            path = f'{self.data_folder}/small/streetview/{idx}_grdView.jpg'
...
class CVACTDatasetTest(Dataset):
    ...
    def __init__(self,
        ...
        files_sat = glob(f'{self.data_folder}/test/satview_polish_polarmap/*_satView_polish.jpg')
        files_ground = glob(f'{self.data_folder}/test/streetview/*_grdView.jpg')
    ...
    def __getitem__(self, index):
        ...
        if self.img_type == "reference":
            path = f'{self.data_folder}/test/satview_polish_polarmap/{idx}_satView_polish.jpg'
        else:
            path = f'{self.data_folder}/test/streetview/{idx}_grdView.jpg'
