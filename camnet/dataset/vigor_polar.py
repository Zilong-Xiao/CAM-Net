...
class VigorDatasetTrain(Dataset):
    ...
    def __init__(self,
        ...
        for city in self.cities:
            ...
            df_tmp["path"] = df_tmp.apply(lambda x: f'{data_folder}/satellite/{city}_polar/{x.sat}', axis=1)
        ...
        for city in self.cities:
            ...
            df_tmp["path_sat"] = df_tmp.apply(lambda x: f'{data_folder}/satellite/{city}_polar/{x.sat}', axis=1)
...
class VigorDatasetEval(Dataset):
    ...
    def __init__(self,
        ...
        for city in self.cities:
            ...
            df_tmp["path_sat_np1"] = df_tmp.apply(lambda x: f'{data_folder}/satellite/{city}_polar/{x.sat_np1}', axis=1)
            df_tmp["path_sat_np2"] = df_tmp.apply(lambda x: f'{data_folder}/satellite/{city}_polar/{x.sat_np2}', axis=1)
            df_tmp["path_sat_np3"] = df_tmp.apply(lambda x: f'{data_folder}/satellite/{city}_polar/{x.sat_np3}', axis=1)
