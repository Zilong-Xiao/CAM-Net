...
from camnet.dataset.cvact import CVACTDatasetEval, CVACTDatasetTest
from camnet.dataset.cvact_bev import CVACTDatasetEval as CVACTDatasetEval_BEV, CVACTDatasetTest as CVACTDatasetTest_BEV
from camnet.dataset.cvact_polar import CVACTDatasetEval as CVACTDatasetEval_Polar , CVACTDatasetTest as CVACTDatasetTest_Polar
from camnet.transforms import get_transforms_val
...
if __name__ == '__main__':
    ...
    img_size_ground_1 = (new_hight, new_width)
    ...
    image_size_sat_2 = (img_size, img_size)
    ...
    mean_3 = data_config_3["mean"]
    std_3 = data_config_3["std"]
    
    image_size_sat_3 = (new_hight, new_width)
    img_size_ground_3 = image_size_sat_3
    ...
    # Eval
    sat_transforms_val_1, ground_transforms_val_1 = get_transforms_val(image_size_sat_1,
                                                                   img_size_ground_1,
                                                                   mean=mean_1,
                                                                   std=std_1,
                                                                   )
    ...
    reference_dataset_val_1 = CVACTDatasetEval(data_folder=config.data_folder ,
                                             split="val",
                                             img_type="reference",
                                             transforms=sat_transforms_val_1,
                                             )
    
    reference_dataloader_val_1 = DataLoader(reference_dataset_val_1,
    ...
    query_dataset_val_1 = CVACTDatasetEval(data_folder=config.data_folder ,
                                         split="val",
                                         img_type="query",    
                                         transforms=ground_transforms_val_1,
                                         )
    
    query_dataloader_val_1 = DataLoader(query_dataset_val_1,
                                      batch_size=config.batch_size,
                                      num_workers=config.num_workers,
                                      shuffle=False,
                                      pin_memory=True)
    ...
    print("Reference Images Val_1:", len(reference_dataset_val_1))
    print("Query Images Val_1:", len(query_dataset_val_1))
    
    #-----------------------------------------------------------------------------#
    # DataLoader_2                                                                  #
    #-----------------------------------------------------------------------------#

    sat_transforms_val_2, ground_transforms_val_2 = get_transforms_val_bev(image_size_sat_2,
                                                                   img_size_ground_2,
                                                                   mean=mean_2,
                                                                   std=std_2,
                                                                   )
    ...
    # Reference Satellite Images
    reference_dataset_val_2 = CVACTDatasetEval_BEV(data_folder=config.data_folder ,
                                             split="val",
                                             img_type="reference",
                                             transforms=sat_transforms_val_2,
                                             )
    
    reference_dataloader_val_2 = DataLoader(reference_dataset_val_2,
                                          batch_size=config.batch_size,
                                          num_workers=config.num_workers,
                                          shuffle=False,
                                          pin_memory=True)
    ...
    # Query Ground Images Test
    query_dataset_val_2 = CVACTDatasetEval_BEV(data_folder=config.data_folder ,
                                         split="val",
                                         img_type="query",    
                                         transforms=ground_transforms_val_2,
                                         )
    
    query_dataloader_val_2 = DataLoader(query_dataset_val_2,
                                      batch_size=config.batch_size,
                                      num_workers=config.num_workers,
                                      shuffle=False,
                                      pin_memory=True)
    ...
    print("Reference Images Val_2:", len(reference_dataset_val_2))
    print("Query Images Val_2:", len(query_dataset_val_2))
    ...
    sat_transforms_val_3, ground_transforms_val_3 = get_transforms_val_polar(image_size_sat_3,
                                                                   img_size_ground_3,
                                                                   mean=mean_3,
                                                                   std=std_3,
                                                                   )
    ...
    # Reference Satellite Images
    reference_dataset_val_3 = CVACTDatasetEval_Polar(data_folder=config.data_folder ,
                                             split="val",
                                             img_type="reference",
                                             transforms=sat_transforms_val_3,
                                             )
    
    reference_dataloader_val_3 = DataLoader(reference_dataset_val_3,
                                          batch_size=config.batch_size,
                                          num_workers=config.num_workers,
                                          shuffle=False,
                                          pin_memory=True)
    ...
    # Query Ground Images Test
    query_dataset_val_3 = CVACTDatasetEval_Polar(data_folder=config.data_folder ,
                                         split="val",
                                         img_type="query",    
                                         transforms=ground_transforms_val_3,
                                         )
    
    query_dataloader_val_3 = DataLoader(query_dataset_val_3,
                                      batch_size=config.batch_size,
                                      num_workers=config.num_workers,
                                      shuffle=False,
                                      pin_memory=True)
    ...
    print("Reference Images Val_3:", len(reference_dataset_val_3))
    print("Query Images Val_3:", len(query_dataset_val_3))


    print("\n{}[{}]{}".format(30*"-", "CVACT_VAL", 30*"-"))  


    rr1_test = evaluate_triple(config=config,
                       model_1=model_1, 
                       model_2=model_2,
                       model_3=model_3,
                       reference_dataloader1=reference_dataloader_val_1, 
                       reference_dataloader2=reference_dataloader_val_2,
                       reference_dataloader3=reference_dataloader_val_3,
                       query_dataloader1=query_dataloader_val_1, 
                       query_dataloader2=query_dataloader_val_2, 
                       query_dataloader3=query_dataloader_val_3,
                       ranks=[1, 5, 10],
                       step_size=500,
                       cleanup=True)
    ...
    # Reference Satellite Images
    reference_dataset_test_1 = CVACTDatasetTest(data_folder=config.data_folder ,
                                              img_type="reference",
                                              transforms=sat_transforms_val_1)
    ...
    # Query Ground Images Test
    query_dataset_test_1 = CVACTDatasetTest(data_folder=config.data_folder ,
                                          img_type="query",    
                                          transforms=ground_transforms_val_1,
                                          )
    ...
    print("Reference Images Test1:", len(reference_dataset_test_1))
    print("Query Images Test1:", len(query_dataset_test_1))          
    ...
    # Reference Satellite Images
    reference_dataset_test_2 = CVACTDatasetTest_BEV(data_folder=config.data_folder ,
                                              img_type="reference",
                                              transforms=sat_transforms_val_2)
    ...
    # Query Ground Images Test
    query_dataset_test_2 = CVACTDatasetTest_BEV(data_folder=config.data_folder ,
                                          img_type="query",    
                                          transforms=ground_transforms_val_2,
                                          )
    ...
    print("Reference Images Test2:", len(reference_dataset_test_2))
    print("Query Images Test2:", len(query_dataset_test_2))
    ...
    # Reference Satellite Images
    reference_dataset_test_3 = CVACTDatasetTest_Polar(data_folder=config.data_folder ,
                                              img_type="reference",
                                              transforms=sat_transforms_val_3)
    ...
    # Query Ground Images Test
    query_dataset_test_3 = CVACTDatasetTest_Polar(data_folder=config.data_folder ,
                                          img_type="query",    
                                          transforms=ground_transforms_val_3,
                                          )
    ...
    print("Reference Images Test3:", len(reference_dataset_test_3))
    print("Query Images Test3:", len(query_dataset_test_3))
