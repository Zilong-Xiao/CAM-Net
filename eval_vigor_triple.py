...
from camnet.dataset.vigor import VigorDatasetEval
from camnet.dataset.vigor_bev import VigorDatasetEval as VigorDatasetEval_BEV
from camnet.dataset.vigor_polar import VigorDatasetEval as VigorDatasetEval_POLAR
...
from camnet.evaluate.vigor import evaluate_triple
...
class Configuration:
    ...
    # Model
    model_1: str = 'convnext_base.fb_in22k_ft_in1k_384'  #convnext_base.fb_in22k_ft_in1k_384
...
if __name__ == '__main__':
    ...
    reference_dataset_test_1 = VigorDatasetEval(data_folder=config.data_folder ,
                                              split="test",
                                              img_type="reference",
    ...
    query_dataset_test_1 = VigorDatasetEval(data_folder=config.data_folder ,
                                          split="test",
                                          img_type="query",
                                          same_area=config.same_area,      
    ...
    # Reference Satellite Images Test
    reference_dataset_test_2 = VigorDatasetEval_BEV(data_folder=config.data_folder ,
                                              split="test",
                                              img_type="reference",
                                              same_area=config.same_area,  
    ...
    # Query Ground Images Test
    query_dataset_test_2 = VigorDatasetEval_BEV(data_folder=config.data_folder ,
                                          split="test",
                                          img_type="query",
                                          same_area=config.same_area,      
    ...
    # Reference Satellite Images Test
    reference_dataset_test_3 = VigorDatasetEval_POLAR(data_folder=config.data_folder ,
                                              split="test",
                                              img_type="reference",
                                              same_area=config.same_area,  
    ...
    # Query Ground Images Test
    query_dataset_test_3 = VigorDatasetEval_POLAR(data_folder=config.data_folder ,
                                          split="test",
                                          img_type="query",
                                          same_area=config.same_area,      
